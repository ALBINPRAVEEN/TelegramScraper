# -*- coding: utf-8 -*-
#!/bin/env python3
# Modified by @i_am_albin_praveen
...
print(gr+"[+] https://github.com/ALBINPRAVEEN/TelegramScraper")
print("\033[92m[+] Telegram Group: \033[96mhttp://t.me/musicwithalby\033[0m")
